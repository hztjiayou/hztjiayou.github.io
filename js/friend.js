...
$(function () { //获取处理友链数据
    $.getJSON("../json_data/friend.json", function (data) {
        ...
        $('.links-content').append("<div class=\"link-navigation\"><div class='friend-title-item'>Love Actually </div>");
        {
            var e = data0;
        ...
        $('.links-content').append("<div class='friend-title-item'>好友们【排名不分先后，刷新后随机重排整请留言告知】</div>");
